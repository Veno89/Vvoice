...
import type { ChannelManager } from '../domain/channel-manager.js';
import { verifyToken, type UserRole } from '../security/auth.js';
import { generateTurnCredentials } from '../security/turn-credentials.js';
import * as userRepo from '../db/user-repo.js';
import { protocolVersion, type ClientMessage } from '../types/protocol.js';
import * as messageRepo from '../db/message-repo.js';
import { send, sendError, broadcastRoom, broadcastAll, type ConnectionMap } from './broadcast.js';
...
export type PeerIndex = Map<string, ConnectionState>;
