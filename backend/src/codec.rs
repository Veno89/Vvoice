...
// Include generated protos (needs to be available in this module's scope)
...
impl Decoder for MumbleCodec {
    ...
    fn decode(&mut self, src: &mut BytesMut) -> Result<Option<Self::Item>, Self::Error> {
        ...
        let packet = match packet_type {
            ...
            1 => MumblePacket::UDPTunnel(UdpTunnel { packet: payload.to_vec() }), // RAW BYTES
...
impl Encoder<MumblePacket> for MumbleCodec {
    ...
    fn encode(&mut self, item: MumblePacket, dst: &mut BytesMut) -> Result<(), Self::Error> {
        let (packet_type, payload) = match item {
            ...
            MumblePacket::UDPTunnel(msg) => (1, msg.packet), // RAW BYTES
